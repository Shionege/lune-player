...
for vid in vids:
    ...
    req = urllib.request.Request(
        ...
        headers={'Content-Type': 'application/json', 'User-Agent': 'com.google.ios.youtube/19.29.1 (iPhone16,2; U; CPU iOS 17_5_1 like Mac OS X; en_US)'}
    )
    ...
    try:
        with urllib.request.urlopen(req, timeout=5, context=ctx) as res:
            ...
            print(f"  IOS Client API -> Found {len(audio_formats)} audio formats!")
            for af in audio_formats[:2]:
                ...
                if direct_url:
                    print(f"  ✅ [SUCCESS FULL AUDIO STREAM FOUND!]")
